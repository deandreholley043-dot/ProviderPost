...
export default function Error({
  ...
  useEffect(() => {
    console.error("[ProviderPost Page Error]", error)
  }, [error])
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Link href="/" className="inline-flex items-center justify-center rounded-lg border border-border bg-card text-foreground px-6 py-2.5 text-sm font-semibold hover:border-pink-300 transition-colors">
          Go to Homepage
        </Link>
        <Link href="/contact" className="inline-flex items-center justify-center rounded-lg border border-border bg-card text-foreground px-6 py-2.5 text-sm font-semibold hover:border-pink-300 transition-colors">
          Contact Support
        </Link>
      </div>
    </div>
